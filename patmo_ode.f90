...
!
    dn(:,patmo_idx_33SO2) = &
        ...
        + krate(:,118)*n(:,patmo_idx_33H2SO4) &
        - krate(:,124)*n(:,patmo_idx_33SO2) &
        + 0.993*(krate(:,128)*n(:,patmo_idx_33CH3SCH3)*n(:,patmo_idx_O)) &
        + 0.993*(krate(:,132)*n(:,patmo_idx_33CH3SCH3)*n(:,patmo_idx_OH)) &
        + 0.993*(krate(:,136)*n(:,patmo_idx_33CH3SCH3)*n(:,patmo_idx_OH)) &
        + krate(:,140)*n(:,patmo_idx_33SO2_1) &
        + krate(:,144)*n(:,patmo_idx_33SO2_1) &
        + krate(:,160)*n(:,patmo_idx_33SO2_3) &
        + krate(:,164)*n(:,patmo_idx_33SO2_3) &
...
!
    dn(:,patmo_idx_36SO2) = &
        ...
        + krate(:,120)*n(:,patmo_idx_36H2SO4) &
        - krate(:,126)*n(:,patmo_idx_36SO2) &
        + 0.993*(krate(:,130)*n(:,patmo_idx_36CH3SCH3)*n(:,patmo_idx_O)) &
        + 0.993*(krate(:,134)*n(:,patmo_idx_36CH3SCH3)*n(:,patmo_idx_OH)) &
        + 0.993*(krate(:,138)*n(:,patmo_idx_36CH3SCH3)*n(:,patmo_idx_OH)) &
        + krate(:,142)*n(:,patmo_idx_36SO2_1) &
        + krate(:,146)*n(:,patmo_idx_36SO2_1) &
        + krate(:,162)*n(:,patmo_idx_36SO2_3) &
        + krate(:,166)*n(:,patmo_idx_36SO2_3) &
...
!
    ...
    dn(:,patmo_idx_34SH) = &
        + krate(:,3)*n(:,patmo_idx_34COS)*n(:,patmo_idx_OH) &
        + 1.17*(krate(:,11)*n(:,patmo_idx_34CS2)*n(:,patmo_idx_OH)) &
        + krate(:,31)*n(:,patmo_idx_34H2S)*n(:,patmo_idx_OH) &
...
!H2SO4 chemistry budget
    ...
    dn(:,patmo_idx_33SH) = &
        + krate(:,2)*n(:,patmo_idx_33COS)*n(:,patmo_idx_OH) &
        + 1.17*(krate(:,10)*n(:,patmo_idx_33CS2)*n(:,patmo_idx_OH)) &
        + krate(:,30)*n(:,patmo_idx_33H2S)*n(:,patmo_idx_OH) &
        + krate(:,34)*n(:,patmo_idx_33H2S)*n(:,patmo_idx_O) &
    ...
    if (end_of_run) then
        ...
        + krate(:,97)*n(:,patmo_idx_32HSO2)*n(:,patmo_idx_O2) &
        + krate(:,117)*n(:,patmo_idx_32H2SO4) &
        + 0.993*(krate(:,127)*n(:,patmo_idx_32CH3SCH3)*n(:,patmo_idx_O)) &
        + 0.993*(krate(:,131)*n(:,patmo_idx_32CH3SCH3)*n(:,patmo_idx_OH)) &
        + 0.993*(krate(:,135)*n(:,patmo_idx_32CH3SCH3)*n(:,patmo_idx_OH)) &
        + krate(:,139)*n(:,patmo_idx_32SO2_1) &
        + krate(:,143)*n(:,patmo_idx_32SO2_1) &
        + krate(:,159)*n(:,patmo_idx_32SO2_3) &
        + krate(:,163)*n(:,patmo_idx_32SO2_3) &
...
!
    ...
    dn(:,patmo_idx_36SH) = &
        + krate(:,4)*n(:,patmo_idx_36COS)*n(:,patmo_idx_OH) &
        + 1.17*(krate(:,12)*n(:,patmo_idx_36CS2)*n(:,patmo_idx_OH)) &
        + krate(:,32)*n(:,patmo_idx_36H2S)*n(:,patmo_idx_OH) &
        + krate(:,36)*n(:,patmo_idx_36H2S)*n(:,patmo_idx_O) &
        + krate(:,40)*n(:,patmo_idx_36H2S)*n(:,patmo_idx_H) &
        - krate(:,48)*n(:,patmo_idx_36SH)*n(:,patmo_idx_O) &
...
!
    ...
    dn(:,patmo_idx_32SH) = &
        + krate(:,1)*n(:,patmo_idx_32COS)*n(:,patmo_idx_OH) &
        + 1.17*(krate(:,9)*n(:,patmo_idx_32CS2)*n(:,patmo_idx_OH)) &
        + krate(:,29)*n(:,patmo_idx_32H2S)*n(:,patmo_idx_OH) &
        + krate(:,33)*n(:,patmo_idx_32H2S)*n(:,patmo_idx_O) &
        + krate(:,37)*n(:,patmo_idx_32H2S)*n(:,patmo_idx_H) &
        - krate(:,45)*n(:,patmo_idx_32SH)*n(:,patmo_idx_O) &
    ...
    if (end_of_run) then
        ...
        + krate(:,99)*n(:,patmo_idx_34HSO2)*n(:,patmo_idx_O2) &
        + krate(:,119)*n(:,patmo_idx_34H2SO4) &
        + 0.993*(krate(:,129)*n(:,patmo_idx_34CH3SCH3)*n(:,patmo_idx_O)) &
        + 0.993*(krate(:,133)*n(:,patmo_idx_34CH3SCH3)*n(:,patmo_idx_OH)) &
        + 0.993*(krate(:,137)*n(:,patmo_idx_34CH3SCH3)*n(:,patmo_idx_OH)) &
        + krate(:,141)*n(:,patmo_idx_34SO2_1) &
        + krate(:,145)*n(:,patmo_idx_34SO2_1) &
        + krate(:,161)*n(:,patmo_idx_34SO2_3) &
        + krate(:,165)*n(:,patmo_idx_34SO2_3) &
...
!
            ...
            budget(j,patmo_idx_34CH3SCH3,3) = &
            + (k_hp(j)-d_hp(j,patmo_idx_34CH3SCH3)) * ngas_hpp(j) * n_p(j,patmo_idx_34CH3SCH3) &
            - (k_hp(j)+d_hp(j,patmo_idx_34CH3SCH3)) * ngas_hpz(j) * n(j,patmo_idx_34CH3SCH3)
...
!
            ...
            budget(j,patmo_idx_34CH3SCH3,4) = &
            + (k_hm(j)-d_hm(j,patmo_idx_34CH3SCH3)) * ngas_hmm(j) * n_m(j,patmo_idx_34CH3SCH3) &
            - (k_hm(j)+d_hm(j,patmo_idx_32CH3SCH3)) * ngas_hmz(j) * n(j,patmo_idx_34CH3SCH3)
...
!    
        budget(12,patmo_idx_32CS2,7) = - wetdep(12,patmo_idx_32CS2)*n(12,patmo_idx_32CS2) 
        budget(12,patmo_idx_32CH3SCH3,7) = - wetdep(12,patmo_idx_32CH3SCH3)*n(12,patmo_idx_32CH3SCH3)
        budget(12,patmo_idx_34CS2,7) = - wetdep(12,patmo_idx_34CS2)*n(12,patmo_idx_34CS2)
        budget(12,patmo_idx_34CH3SCH3,7) = - wetdep(12,patmo_idx_34CH3SCH3)*n(12,patmo_idx_34CH3SCH3)
        do j=11,1,-1
...
!            
            ...
            budget(j,patmo_idx_32CS2,7) = wetdep(j+1,patmo_idx_32CS2)*n(j+1,patmo_idx_32CS2) & 
                - wetdep(j,patmo_idx_32CS2)*n(j,patmo_idx_32CS2) 
            budget(j,patmo_idx_32CH3SCH3,7) = wetdep(j+1,patmo_idx_32CH3SCH3)*n(j+1,patmo_idx_32CH3SCH3) &
                - wetdep(j,patmo_idx_32CH3SCH3)*n(j,patmo_idx_32CH3SCH3)
            budget(j,patmo_idx_34CS2,7) = wetdep(j+1,patmo_idx_34CS2)*n(j+1,patmo_idx_34CS2) & 
                - wetdep(j,patmo_idx_34CS2)*n(j,patmo_idx_34CS2)
            budget(j,patmo_idx_34CH3SCH3,7) = wetdep(j+1,patmo_idx_34CH3SCH3)*n(j+1,patmo_idx_34CH3SCH3) &
                - wetdep(j,patmo_idx_34CH3SCH3)*n(j,patmo_idx_34CH3SCH3)
      enddo 
    endif 
!     
    !end budget_wetdep
