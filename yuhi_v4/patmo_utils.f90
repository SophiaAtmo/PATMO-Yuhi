...
contains
  ...
  function getSpeciesMass()
    ...
    getSpeciesMass(patmo_idx_32S2) = 1.071507d-22
    getSpeciesMass(patmo_idx_33S2) = 1.071507d-22
    getSpeciesMass(patmo_idx_34S2) = 1.071507d-22
    getSpeciesMass(patmo_idx_36S2) = 1.071507d-22
    getSpeciesMass(patmo_idx_32SCSOH) = 1.456531d-22
    getSpeciesMass(patmo_idx_33SCSOH) = 1.456531d-22
    getSpeciesMass(patmo_idx_34SCSOH) = 1.456531d-22
    getSpeciesMass(patmo_idx_36SCSOH) = 1.456531d-22
    ...
    getSpeciesMass(patmo_idx_32CS2E) = 1.171919d-22
    getSpeciesMass(patmo_idx_M) = 0d0
    getSpeciesMass(patmo_idx_33CS2E) = 1.171919d-22
    getSpeciesMass(patmo_idx_34CS2E) = 1.171919d-22
    getSpeciesMass(patmo_idx_36CS2E) = 1.171919d-22
  ...
  function getSpeciesNames()
    ...
    getSpeciesNames(patmo_idx_32S2) = "32S2"
    getSpeciesNames(patmo_idx_33S2) = "33S2"
    getSpeciesNames(patmo_idx_34S2) = "34S2"
    getSpeciesNames(patmo_idx_36S2) = "36S2"
    getSpeciesNames(patmo_idx_32SCSOH) = "32SCSOH"
    getSpeciesNames(patmo_idx_33SCSOH) = "33SCSOH"
    getSpeciesNames(patmo_idx_34SCSOH) = "34SCSOH"
    getSpeciesNames(patmo_idx_36SCSOH) = "36SCSOH"
    ...
    getSpeciesNames(patmo_idx_32CS2E) = "32CS2E"
    getSpeciesNames(patmo_idx_M) = "M"
    getSpeciesNames(patmo_idx_33CS2E) = "33CS2E"
    getSpeciesNames(patmo_idx_34CS2E) = "34CS2E"
    getSpeciesNames(patmo_idx_36CS2E) = "36CS2E"
  ...
  function getTotalMassNuclei_S()
    ...
    do icell=1,cellsNumber
      ...
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_32S2) * nall(icell,patmo_idx_32S2) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_33S2) * nall(icell,patmo_idx_33S2) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_34S2) * nall(icell,patmo_idx_34S2) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_36S2) * nall(icell,patmo_idx_36S2) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_32SCSOH) * nall(icell,patmo_idx_32SCSOH)
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_33SCSOH) * nall(icell,patmo_idx_33SCSOH)
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_34SCSOH) * nall(icell,patmo_idx_34SCSOH)
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_36SCSOH) * nall(icell,patmo_idx_36SCSOH)
      ...
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_32CS2E) * nall(icell,patmo_idx_32CS2E) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_33CS2E) * nall(icell,patmo_idx_33CS2E) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_34CS2E) * nall(icell,patmo_idx_34CS2E) * 2d0
      getTotalMassNuclei_S = getTotalMassNuclei_S + m(patmo_idx_36CS2E) * nall(icell,patmo_idx_36CS2E) * 2d0
  ...
  function getTotalMassNuclei_E()
    ...
    do icell=1,cellsNumber
      getTotalMassNuclei_E = getTotalMassNuclei_E + m(patmo_idx_32CS2E) * nall(icell,patmo_idx_32CS2E)
      getTotalMassNuclei_E = getTotalMassNuclei_E + m(patmo_idx_33CS2E) * nall(icell,patmo_idx_33CS2E)
      getTotalMassNuclei_E = getTotalMassNuclei_E + m(patmo_idx_34CS2E) * nall(icell,patmo_idx_34CS2E)
      getTotalMassNuclei_E = getTotalMassNuclei_E + m(patmo_idx_36CS2E) * nall(icell,patmo_idx_36CS2E)
    end do
  ...
  function getTotalMassNuclei_O()
    ...
    do icell=1,cellsNumber
      ...
      getTotalMassNuclei_O = getTotalMassNuclei_O + m(patmo_idx_32SCSOH) * nall(icell,patmo_idx_32SCSOH)
      getTotalMassNuclei_O = getTotalMassNuclei_O + m(patmo_idx_33SCSOH) * nall(icell,patmo_idx_33SCSOH)
      getTotalMassNuclei_O = getTotalMassNuclei_O + m(patmo_idx_34SCSOH) * nall(icell,patmo_idx_34SCSOH)
      getTotalMassNuclei_O = getTotalMassNuclei_O + m(patmo_idx_36SCSOH) * nall(icell,patmo_idx_36SCSOH)
  ...
  function getTotalMassNuclei_H()
    ...
    do icell=1,cellsNumber
      ...
      getTotalMassNuclei_H = getTotalMassNuclei_H + m(patmo_idx_32SCSOH) * nall(icell,patmo_idx_32SCSOH)
      getTotalMassNuclei_H = getTotalMassNuclei_H + m(patmo_idx_33SCSOH) * nall(icell,patmo_idx_33SCSOH)
      getTotalMassNuclei_H = getTotalMassNuclei_H + m(patmo_idx_34SCSOH) * nall(icell,patmo_idx_34SCSOH)
      getTotalMassNuclei_H = getTotalMassNuclei_H + m(patmo_idx_36SCSOH) * nall(icell,patmo_idx_36SCSOH)
  ...
  function getTotalMassNuclei_C()
    ...
    do icell=1,cellsNumber
      ...
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_32SCSOH) * nall(icell,patmo_idx_32SCSOH)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_33SCSOH) * nall(icell,patmo_idx_33SCSOH)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_34SCSOH) * nall(icell,patmo_idx_34SCSOH)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_36SCSOH) * nall(icell,patmo_idx_36SCSOH)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_32CS2E) * nall(icell,patmo_idx_32CS2E)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_33CS2E) * nall(icell,patmo_idx_33CS2E)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_34CS2E) * nall(icell,patmo_idx_34CS2E)
      getTotalMassNuclei_C = getTotalMassNuclei_C + m(patmo_idx_36CS2E) * nall(icell,patmo_idx_36CS2E)
